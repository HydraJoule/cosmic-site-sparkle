      ...
      <section className="py-20 bg-gradient-to-br from-muted/50 to-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Palette, title: "Modern Design", description: "Clean, contemporary layouts that impress visitors" },
              { icon: Code, title: "Clean Code", description: "Well-structured, maintainable code for long-term success" },
              { icon: Rocket, title: "SEO Optimized", description: "Built-in optimization to help you rank higher" },
              { icon: Clock, title: "Fast Delivery", description: "Quick turnaround without compromising quality" }
            ].map((feature, index) => (
              <Card key={index} className="text-center border-0 shadow-soft hover:shadow-cosmic transition-all duration-300 hover:-translate-y-1">
                <CardHeader>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="text-center relative">
                ...
                {index < 2 && (
                  <div className="hidden md:block absolute top-8 left-1/2 w-full h-0.5 bg-gradient-to-r from-primary/50 to-transparent transform translate-x-8"></div>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <Card key={index} className="border-0 shadow-soft hover:shadow-cosmic transition-all duration-300">
